...
href="verifyApply" target="mainFrame"><IMG src="Top.files/mail.gif" 
align=absMiddle border=0></A> 您有新消息<A id=HyperLink1 
href="verifyApply" target="mainFrame">5</A>条 <IMG 
src="Top.files/menu_seprator.gif" align=absMiddle> <A id=HyperLink2 
href="../index.html" target="blank"  >返回首页</A> <IMG 
...
style="BACKGROUND-IMAGE: url(../images/bg_nav.gif); BACKGROUND-REPEAT: repeat-x; HEIGHT: 30px">
      ...
      id=lblBra>中硬国际公司</SPAN> <SPAN id=lblDep><%=empVo.getDepName() %></SPAN> [<%=empVo.getEmpName() %> ] 光临 </DIV>
            </TD>
      ...
      href="../login.htm" target=_top><IMG 
      src="Top.files/nav_changePassword.gif" align=absMiddle border=0>重新登录</A> <A href="EmployeeMgr.files/UpdatePwd.jsp" 
