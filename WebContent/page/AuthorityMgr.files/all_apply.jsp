...
<DIV>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(../../images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">所有审批 </SPAN><SPAN 
          	...
          	<form action="queryApply">
	          	...
	          	<div align="center" style="margin: 10px;">
	          		...
	          		<select name="status">
	          			...
	          			<option value="2">拒绝审批</option>
	          		</select>
	          		<input class="buttonBlue" type="submit" value="查询">
	          	</div>
        	</form>
	          <form action="">
	      ...
	      border=1>
	              <TBODY>
	                <TR>
	                  ...
	                  <th class="gridViewHeader" scope="col">申请状态</th>
	              ...
	              %>
	                <TR>
	                  ...
	                  <td class="gridViewItem"><a class="cmdField" href="all_apply_holiday.html">查询详情</a></td>
	                </TR>
	              <%
	              	}
	              %>
