...
<DIV>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(../../images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">审批加薪 </SPAN><SPAN 
    ...
    vAlign=top align=center>
      ...
      border=1>
              ...
              <TBODY>
                ...
                <TR>
                  <th class=gridViewHeaderMax>申请薪水</th>
                ...
                <TR>
                	...
                	<A class=cmdField 
            href="verifyApply?type=<%=flag%>&empId=<%=applyList.get(0).get("empId") %>&status=1&salary=<%=applyList.get(0).get("applySalary") %>&applyId=<%=applyList.get(0).get("applySalaryId") %>">通过申请</A>
            		<A class=cmdField 
            href="verifyApply?type=<%=flag%>&status=2&applyId=<%=applyList.get(0).get("applySalaryId") %>">拒绝申请</A>
            		</TD>          
                </TR>                                                     
              </TBODY>
            </TABLE>
