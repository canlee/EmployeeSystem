...
<DIV>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(../../images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">增加岗位 </SPAN><SPAN 
    ...
    vAlign=top align=middle>
          <DIV>
	          ...
	          <form id="form_insert_post" action="insertPost" method="post" style="margin-top: 50px;">
	      ...
	      border=1>
	              <TBODY>
	                ...
	                <TR>
	                  ...
	                  <th class="gridViewItem"><input type="text" name="postName" style="width: 200px;"></th>
	                </TR>
	                <TR>
